...
<div style="font-size: 125%">  
 <a href="https://join.slack.com/t/govmeeting/shared_invite/zt-eavi8zwh-4t900JzP~WJCo2Z7Z2tk0A"> Govmeeting Slack Workspace<img src="images/Slack workspace_site_launch.png"> </a> </div>
...
The _TESTDATA and _SECRETS folders will contain files that should not be published to Github. Therefore they need to be located outside of the repository folder.


You will find sample test data on <a href="https://drive.google.com/drive/folders/1_I8AEnMNoPud7XZ_zIYfyGbvy96b-PyN?usp=sharing"> Google Drive. </a> In order to run WebApp and WorkflowApp, you need to download the Google Drive contents into the _TESTDATA folder.
...
Information on the _SECRETS files is in the setup instructions for <a href="#GoogleCloud"> Google Cloud Platform </a> and <a href="#GoogleApi"> Google API Keys. </a> You will only need these files if you are working on speech-to-text  transcription or on user login.
