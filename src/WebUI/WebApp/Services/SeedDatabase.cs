...
namespace GM.WebUI.WebApp.Services
{
    public static class SeedDatabase
    {
        ...
        private static Govbody AddGovbody(string name, GovLocation loc)
        {
        ...
        private static void AddElectedOfficials(List<ElectedOfficial> officials, Govbody loc)
        {
        ...
        private static void AddAppointedOfficials(List<AppointedOfficial> officials, Govbody loc)
        {
