...
export module swaggerapi {
  ...
  export class GovLocationClient {
     ...
     */
    register(command: RegisterGovLocationCommand): Observable<number> {
     ...
     * @param id Id of GovLocation
     */
    getGovLocation(id: number): Observable<GovLocationDetails_Dto> {
      let url_ = this.baseUrl + '/api/GovLocation/GetGovLocation/{id}';
      ...
      return this.http
        ...
        .pipe(
          _observableMergeMap((response_: any) => {
            return this.processGetGovLocation(response_);
          })
        )
        .pipe(
          _observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
              try {
                return this.processGetGovLocation(<any>response_);
              } catch (e) {
                return <Observable<GovLocationDetails_Dto>>(<any>_observableThrow(e));
              }
            } else return <Observable<GovLocationDetails_Dto>>(<any>_observableThrow(response_));
          })
        );
    }

    protected processGetGovLocation(response: HttpResponseBase): Observable<GovLocationDetails_Dto> {
      const status = response.status;
      const responseBlob =
        response instanceof HttpResponse
          ? response.body
      ...
      if (status === 200) {
        return blobToText(responseBlob).pipe(
          _observableMergeMap((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === '' ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GovLocationDetails_Dto.fromJS(resultData200);
            return _observableOf(result200);
          })
        );
      } else if (status !== 200 && status !== 204) {
      ...
      return _observableOf<GovLocationDetails_Dto>(<any>null);
    }
  }
  ...
  export class GovbodyClient {
     ...
     */
    register(command: RegisterGovbody_Command): Observable<number> {
  ...
  export class RegisterGovLocationCommand extends GovLocation_Dto implements IRegisterGovLocationCommand {
    constructor(data?: IRegisterGovLocationCommand) {
      super(data);
    }
    ...
    static fromJS(data: any): RegisterGovLocationCommand {
      data = typeof data === 'object' ? data : {};
      let result = new RegisterGovLocationCommand();
      result.init(data);
      return result;
    }
  ...
  export interface IRegisterGovLocationCommand extends IGovLocation_Dto {}
  ...
  export class GovLocationDetails_Dto implements IGovLocationDetails_Dto {
    name?: string | undefined;
    type!: GovlocTypes;
    ...
    constructor(data?: IGovLocationDetails_Dto) {
      if (data) {
        for (var property in data) {
          if (data.hasOwnProperty(property)) (<any>this)[property] = (<any>data)[property];
        }
    ...
    init(_data?: any) {
      if (_data) {
        ...
        if (Array.isArray(_data['govbodies'])) {
          ...
          for (let item of _data['govbodies']) this.govbodies!.push(Govbody.fromJS(item));
        }
      }
    }

    static fromJS(data: any): GovLocationDetails_Dto {
      data = typeof data === 'object' ? data : {};
      let result = new GovLocationDetails_Dto();
      result.init(data);
      return result;
    }
    ...
    toJSON(data?: any) {
      ...
      if (Array.isArray(this.govbodies)) {
        data['govbodies'] = [];
        for (let item of this.govbodies) data['govbodies'].push(item.toJSON());
      }
      return data;
    }
  }

  export interface IGovLocationDetails_Dto {
    name?: string | undefined;
    type: GovlocTypes;
    code?: string | undefined;
    parentLocation?: GovLocation | undefined;
    ...
    init(_data?: any) {
      ...
      if (_data) {
        ...
        if (Array.isArray(_data['languages'])) {
          ...
          for (let item of _data['languages']) this.languages!.push(Language.fromJS(item));
        }
      }
    }
  ...
  export class Govbody extends AuditEntity implements IGovbody {
    ...
    init(_data?: any) {
      ...
      if (_data) {
        ...
        if (Array.isArray(_data['meetings'])) {
          ...
          for (let item of _data['meetings']) this.meetings!.push(Meeting.fromJS(item));
        }
        if (Array.isArray(_data['topics'])) {
          this.topics = [] as any;
          for (let item of _data['topics']) this.topics!.push(Topic.fromJS(item));
        }
        if (Array.isArray(_data['scheduledMeetings'])) {
          this.scheduledMeetings = [] as any;
          for (let item of _data['scheduledMeetings']) this.scheduledMeetings!.push(ScheduledMeeting.fromJS(item));
        }
      }
    }
    ...
    toJSON(data?: any) {
      ...
      if (Array.isArray(this.meetings)) {
        data['meetings'] = [];
        for (let item of this.meetings) data['meetings'].push(item.toJSON());
      }
      if (Array.isArray(this.topics)) {
        data['topics'] = [];
        for (let item of this.topics) data['topics'].push(item.toJSON());
      ...
      if (Array.isArray(this.scheduledMeetings)) {
        ...
        for (let item of this.scheduledMeetings) data['scheduledMeetings'].push(item.toJSON());
      }
      super.toJSON(data);
      return data;
    }
  ...
  export class Meeting extends BaseEntity implements IMeeting {
    ...
    init(_data?: any) {
      ...
      if (_data) {
        ...
        if (Array.isArray(_data['sections'])) {
          this.sections = [] as any;
          for (let item of _data['sections']) this.sections!.push(Section.fromJS(item));
        }
      }
    }
  ...
  export class Section extends BaseEntity implements ISection {
    ...
    init(_data?: any) {
      ...
      if (_data) {
        ...
        if (Array.isArray(_data['topicDiscussions'])) {
          this.topicDiscussions = [] as any;
          for (let item of _data['topicDiscussions']) this.topicDiscussions!.push(TopicDiscussion.fromJS(item));
        }
      }
    }
  ...
  export class TopicDiscussion extends BaseEntity implements ITopicDiscussion {
    ...
    init(_data?: any) {
      ...
      if (_data) {
        ...
        if (Array.isArray(_data['talks'])) {
          this.talks = [] as any;
          for (let item of _data['talks']) this.talks!.push(Talk.fromJS(item));
        }
      }
    }
  ...
  export class RegisterGovbody_Command extends GovbodyDetails_Dto implements IRegisterGovbody_Command {
    constructor(data?: IRegisterGovbody_Command) {
      super(data);
    }
    ...
    static fromJS(data: any): RegisterGovbody_Command {
      data = typeof data === 'object' ? data : {};
      let result = new RegisterGovbody_Command();
      result.init(data);
      return result;
    }
  ...
  export interface IRegisterGovbody_Command extends IGovbodyDetails_Dto {}
