...
export class ApiClient implements IApiClient {
    ...
    viewMeetingGet(meetingId: number): Observable<ViewMeeting_Dto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processViewMeetingGet(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<ViewMeeting_Dto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ViewMeeting_Dto>;
        }));
    }
    ...
    viewMeetingPut(meetingId: number, govbodyName: string | null, locationName: string | null, date: string | null, topics: ViewMeetingTopic_Dto[] | null, speakers: ViewMeetingSpeaker_Dto[] | null, sections: ViewMeetingSection_Dto[] | null): Observable<boolean> {
            ...
            topics && topics.forEach((item, index) => {
                for (let attr in item)
        			if (item.hasOwnProperty(attr)) {
        				url_ += "Topics[" + index + "]." + attr + "=" + encodeURIComponent("" + (item as any)[attr]) + "&";
        			}
            });
        if (speakers === undefined)
            ...
            speakers && speakers.forEach((item, index) => {
                for (let attr in item)
        			if (item.hasOwnProperty(attr)) {
        				url_ += "Speakers[" + index + "]." + attr + "=" + encodeURIComponent("" + (item as any)[attr]) + "&";
        			}
            });
        if (sections === undefined)
            ...
            sections && sections.forEach((item, index) => {
                for (let attr in item)
        			if (item.hasOwnProperty(attr)) {
        				url_ += "Sections[" + index + "]." + attr + "=" + encodeURIComponent("" + (item as any)[attr]) + "&";
        			}
            });
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processViewMeetingPut(response_ as any);
                } catch (e) {
    ...
    editMeetingGet(meetingId: number, part: number): Observable<EditMeeting_Dto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processEditMeetingGet(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<EditMeeting_Dto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<EditMeeting_Dto>;
        }));
    }
    ...
    editMeetingPost(value: EditMeeting_Dto, meetingId: number, part: number): Observable<boolean> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processEditMeetingPost(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<boolean>;
                }
            } else
...
export class GovLocationClient implements IGovLocationClient {
    ...
    getMyGovLocations(): Observable<GovLocation_Dto[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetMyGovLocations(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<GovLocation_Dto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GovLocation_Dto[]>;
        }));
    }
...
export class GovbodyClient implements IGovbodyClient {
    ...
    getGovbodies(id: number): Observable<Govbody_Dto[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetGovbodies(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<Govbody_Dto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<Govbody_Dto[]>;
        }));
    }
    ...
    getGovbody(id: number): Observable<GovbodyDetails_Dto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetGovbody(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<GovbodyDetails_Dto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GovbodyDetails_Dto>;
        }));
    }
