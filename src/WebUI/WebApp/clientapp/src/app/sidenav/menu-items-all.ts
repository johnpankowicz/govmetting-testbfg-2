...
const MenuItemsAbout = new NavItem(EntryType.parent, 'About', '', [
  ...
  new NavItem(EntryType.parent, 'Developer', 'school', [
...
const MenuItemsAboutBeta = new NavItem(EntryType.parent, 'About', '', [
