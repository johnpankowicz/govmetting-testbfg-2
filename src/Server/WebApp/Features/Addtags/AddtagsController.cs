...
namespace WebApp.Features.Addtags
{
    ...
    public class AddtagsController : Controller
    {
        ...
        // GET: api/addtags
        [HttpGet]
        public AddtagsView Get()
        {
            // Normally Get() would receive the paramaters that we are passing below to addtags.Get(). For now, this is hard-coded.
            AddtagsView ret = addtags.Get("johnpank", "USA", "PA", "Philadelphia", "Philadelphia", "CityCouncil", "en", "2014-09-25");
            return ret;
        }
        ...
        public void Post([FromBody]AddtagsView value)
