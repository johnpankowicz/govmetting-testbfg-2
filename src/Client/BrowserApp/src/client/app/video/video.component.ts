...
export class VideoComponent {
    ...
    constructor(private appData: AppData) {
        console.log('VideoComponent constructor isServerRunning=' + appData.isServerRunning + '   isDataFromMemory=' + appData.isDataFromMemory);
        // Todo: Full videos will be split into pieces which will be processed seperately. See Backend/AutoTranscription/SplitVideo
        // Todo: Compose URL to handle production and development
