...
<li> ক্লোন করা ভাণ্ডারটিতে "SECRETS" নামে একটি ভাইবোন ফোল্ডার তৈরি করুন </li>
</ul>
<p> "SECRETS" ফোল্ডারটি কী এবং পাসওয়ার্ডগুলির জন্য যা সর্বজনীন সংগ্রহস্থলে সংরক্ষিত নেই। গুগল এপিআই পরিষেবা চালানোর জন্য এগুলির প্রয়োজন হবে। </p>
<hr />
...
<li>
<p> আপনি রেপো ক্লোন করার সময় যে ফাইলটি তৈরি করেছেন <code>SECRETS</code> ফাইলের মধ্যে রেখে দিন <code>SECRETS</code> </p>
</li>
<li>
...
<p> "SECRETS" ফোল্ডারে "appsettings.Development.json" নামে একটি ফাইল তৈরি করুন। এটিতে আপনার সদ্য প্রাপ্ত চাবিগুলি থাকা উচিত: </p>
