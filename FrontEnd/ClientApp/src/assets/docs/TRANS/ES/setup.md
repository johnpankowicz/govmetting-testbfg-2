...
<li><p> Coloque el archivo en la carpeta <code>SECRETS</code> que creó cuando clonó el repositorio. </p></li>
...
</ul><p> Cree un archivo llamado "appsettings.Development.json" en la carpeta "SECRETS". Debe contener las claves que acaba de obtener: </p><pre> <code>{ "ExternalAuth": { "Google": { "ClientId": "your-client-Id", "ClientSecret": "your-client-secret" } }, "ReCaptcha:SiteKey": "your-site-key", "ReCaptcha:Secret": "your-secret" }</code> </pre><hr /><h2> Prueba reCaptcha </h2>
<ul>
