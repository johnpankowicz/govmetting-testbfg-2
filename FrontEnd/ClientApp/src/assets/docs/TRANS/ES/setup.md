...
<li> Presione F5 (depurar) o Ctrl-F5 (ejecutar sin depurar) 
<ul>
<li> El navegador Chrome se abrirá y después de un breve retraso, ClientApp aparecerá en localhost: 5000. </li>
</ul></li>
</ul><h3> Notas </h3>
...
<p> WorkflowApp procesa textos de transcripción y transcribe grabaciones. La transcripción de grabaciones requiere una <a href="about?id=setup#GoogleCloud">cuenta de Google Cloud.</a> </p>

<p> WorkflowApp crea una carpeta hermana para la carpeta del proyecto (y TESTDATA), llamada "DATAFILES". Dentro de DATAFILES hay 3 subcarpetas: </p>
...
<p> Para facilitar las pruebas, WorkflowApp copia archivos de TESTDATA a DATAFILES / RECEIVED cuando se inicia. </p>
...
<p> Además de las transcripciones de prueba, también puede procesar las suyas. Los archivos de prueba son transcripciones de las reuniones del consejo municipal de Filadelfia, Pensilvania, EE. UU. Para manejar otros formatos de transcripción, deberá agregar un método a ProcessTranscript_Lib. Ver el <a href="https://github.com/govmeeting/govmeeting/issues/93">número 93</a> . Finalmente, el objetivo es escribir código que maneje automáticamente todos o la mayoría de los formatos sin código personalizado. </p>
<hr />
