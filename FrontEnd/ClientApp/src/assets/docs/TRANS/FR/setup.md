...
<li> Appuyez sur F5 (débogage) ou Ctrl-F5 (exécution sans débogage) 
<ul>
<li> Le navigateur Chrome s&#39;ouvrira et après un bref délai, ClientApp apparaîtra sur localhost: 5000. </li>
</ul></li>
</ul><h3> Remarques </h3>
...
<p> WorkflowApp traite les textes de transcription et transcrit les enregistrements. La transcription des enregistrements nécessite un <a href="about?id=setup#GoogleCloud">compte Google Cloud.</a> </p>

<p> WorkflowApp crée un dossier frère dans le dossier du projet (et TESTDATA), appelé "DATAFILES". Dans DATAFILES, il y a 3 sous-dossiers: </p>
...
<p> Pour faciliter les tests, WorkflowApp copie les fichiers de TESTDATA vers DATAFILES / RECEIVED au démarrage. </p>
...
<p> Outre les transcriptions de test, vous pouvez également traiter les vôtres. Les fichiers de test sont des transcriptions des réunions du conseil municipal de Philadelphie, PA, USA. Afin de gérer d&#39;autres formats de transcription, vous devrez ajouter une méthode à ProcessTranscript_Lib. Voir <a href="https://github.com/govmeeting/govmeeting/issues/93">numéro 93</a> . Finalement, l&#39;objectif est d&#39;écrire du code qui gère automatiquement tous ou la plupart des formats sans code personnalisé. </p>
<hr />
