...
<li> “分叉” github上的项目</li>
<li>在本地克隆项目</li>
<li>为克隆的存储库创建一个名为“ SECRETS”的同级文件夹</li>
</ul>
<p> “ SECRETS”文件夹用于未存储在公共存储库中的密钥和密码。这些将是运行Google API服务所必需的。 </p>
<hr />
...
<li>
<p>将文件放在克隆存储库时创建的<code>SECRETS</code>文件夹中。 </p>
</li>
<li>
...
<p>在“ SECRETS”文件夹中创建一个名为“ appsettings.Development.json”的文件。它应该包含您刚刚获得的密钥： </p>
