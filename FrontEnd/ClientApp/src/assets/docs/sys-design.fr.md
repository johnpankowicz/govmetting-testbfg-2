...
</style><!-- Note the controller for this page is app/about-project/sys-desigh/sys-design.ts --><mat-card><mat-card-title class="cardtitle"> Conception </mat-card-title>
