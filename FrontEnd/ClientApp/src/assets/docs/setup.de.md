...
<li> Erstellen Sie einen Geschwisterordner für das geklonte Repository mit dem Namen "_SECRETS". </li>
</ul>
<p> Der Ordner "_SECRETS" enthält Schlüssel und Kennwörter, die nicht im öffentlichen Repository gespeichert sind. Diese werden benötigt, um Google API-Dienste auszuführen. </p>
<hr />
...
<li>
<p> Legen Sie die Datei in den Ordner <code>_SECRETS</code> , den Sie beim <code>_SECRETS</code> des <code>_SECRETS</code> erstellt haben. </p>
</li>
<li>
...
<p> Erstellen Sie eine Datei mit dem Namen "appsettings.Development.json" im Ordner "_SECRETS". Es sollte die Schlüssel enthalten, die Sie gerade erhalten haben: </p>
